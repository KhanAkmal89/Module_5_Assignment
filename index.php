...
<body>
    <section class="bg-gray-50 h-screen flex flex-col items-center justify-center dark:bg-gray-900">
        ...
        <div class="space-x-4">
        <button
                class="px-6 py-2 text-teal-500 border-2 border-teal-500 rounded hover:bg-red-500 hover:text-white duration-150 ease-in-out">
                <a href="login.php">Login</a>
            </button>
            <button
                class="px-6 py-2 text-teal-500 border-2 border-teal-500 rounded hover:bg-orange-500 hover:text-white duration-150 ease-in-out">
